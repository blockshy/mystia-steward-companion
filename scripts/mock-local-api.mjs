    ...
    missions: [
      {
        ...
        activationHint: 'enter-target-day-map',
      },
      {
        label: 'CORE_MOCK_TRACKING',
...
function buildHealth() {
  ...
  return {
    ...
    nightBusinessAutomationAllowed: false,
    nightBusinessAutomationBlockReason: 'night-business-lifecycle-unavailable',
    runtimeNightBusinessAutomationStatus: 'mock automation waiting for active business',
