...
- 任务页可读取当前进度中可接或正在推进的交互任务，支持状态筛选，并尽量显示未接取 NPC 所在场景。
- 独立伴随窗口会记住上次的位置和大小，下次启动时自动恢复。
- 独立伴随窗口可在 `设置` 页调整背景透明度、置顶状态、主题、焦点切换行为、缺失厨具过滤、推荐排序、实验性游戏界面置顶和目标厨具高亮。
- 独立伴随窗口支持手柄导航，可用摇杆/十字键移动、确认、返回、切页、滚动和收藏推荐项。
- 设置页提供实验性自动化总开关和自动化参数；开启后可在经营中页分别配置稀客订单和普客订单的处理阶段，并查看厨具预约和送餐盘压力。自动开始料理时会固定尝试完成原生 QTE 奖励结算。
