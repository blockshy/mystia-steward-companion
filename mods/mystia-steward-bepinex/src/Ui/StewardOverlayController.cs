...
using MystiaSteward.Plugin;
using MystiaSteward.Save;
using UnityEngine;
using UnityEngine.SceneManagement;

namespace MystiaSteward.Ui;
...
internal sealed class StewardOverlayController
{
    ...
    private void PublishLocalApiSnapshot()
    {
        ...
        try
        {
            ...
            {
                PluginVersion = MystiaStewardPlugin.PluginVersion,
    ...
    private void DrawPanelChrome()
    {
        ...
        try
        {
            ...
            GUI.Label(new Rect(_windowRect.x + 18, _windowRect.y + 9, 260, 24), "Mystia Steward", _titleStyle ?? GUI.skin.label);
            GUI.Label(
