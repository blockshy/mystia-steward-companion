...
public sealed class StewardPluginConfig
{
    private StewardPluginConfig(
        ...
        ConfigEntry<int> aggregateModLogMaxFileCount,
        ...
        ConfigEntry<bool> famousShopOverride)
    {
        ...
        AggregateModLogMaxFileCount = aggregateModLogMaxFileCount;
    ...
    public ConfigEntry<int> AggregateModLogMaxFileCount { get; }
    ...
    public static StewardPluginConfig Bind(ConfigFile config)
    {
        return new StewardPluginConfig(
            ...
            config.Bind("Diagnostics", "AggregateModLogPath", "", "Optional aggregate log path. Empty uses BepInEx/config/MystiaStewardCompanion/aggregate-mod.log."),
            config.Bind("Diagnostics", "AggregateModLogMaxFileCount", AggregateModLogService.DefaultMaxFileCount, "Maximum aggregate log files to keep, including the active file. Default 30 keeps about 300 MB because each file rotates at 10 MB."),
